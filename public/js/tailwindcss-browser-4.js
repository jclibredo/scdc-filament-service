 ...
 * Original file: /npm/@tailwindcss/browser@4.3.3/dist/index.global.js
 *
...
(() => {
    ...
    function l(e) {
        return "selector" === e.kind && e.value.charCodeAt(0) === m;
    }
    function s(e) {
        if ("selector" !== e.kind) return !1;
    ...
    function g(l) {
        ...
        let s,
            ...
            y = "";
        function x(e = v) {
            return 1 === e.length ? e[0] : k ? t(e) : r(e);
        }
        function $(e) {
            let t = v[v.length - 1];
            "compound" === t?.kind
                ? t.nodes.push(e)
                : t && "list" !== t.kind && "combinator" !== t.kind
                  ? (v[v.length - 1] = r([t, e]))
                  : v.push(e);
        }
        for (let r = 0; r < l.length; r++) {
            let z = l.charCodeAt(r);
            switch (z) {
                case 44:
                    for (
                        y.length > 0 && ($(i(y)), (y = ""));
                    ...
                    if (b) (b.nodes.push(x()), (v = []), (k = !1));
                    else {
                        let e = o([x(v.splice(0))]);
                        (v.push(e), (b = e), (v = []), (k = !1));
                    }
                    break;
                case 62:
                ...
                case 40: {
                    ...
                    if (
                        ...
                        let t = r + 1,
                            n = 0;
                        for (let e = r + 1; e < l.length; e++)
                            if (((s = l.charCodeAt(e)), 40 !== s)) {
                                if (41 === s) {
                                    if (0 === n) {
                                        r = e;
                                        break;
                ...
                case 41: {
                    (y.length > 0 && ($(i(y)), (y = "")),
                        b
                            ? b.nodes.push(x())
                            : k && v.splice(0, v.length, t(v.splice(0))));
                    let e = w.pop();
                    ((v = e?.target ?? c),
                        (b = e?.currentList ?? null),
                        (k = e?.containsCombinator ?? !1));
                    break;
                }
                case d:
                case u:
        ...
        return (
            y.length > 0 && $(i(y)),
            b ? b.nodes.push(x()) : k && v.splice(0, v.length, t(v.splice(0))),
            c
        );
    }
    function v(e) {
    ...
    function b(e, t) {
        let r = t?.from ? { file: t.from, code: e } : null;
        "\ufeff" === e[0] && (e = " " + e.slice(1));
        let n,
            o = [],
            i = [],
        ...
        for (let t = 0; t < e.length; t++) {
            ...
            if (13 !== f || ((n = e.charCodeAt(t + 1)), n !== k))
                if (92 === f)
                    ("" === c && (d = t), (c += e.slice(t, t + 2)), (t += 1));
                else if (47 === f && 42 === e.charCodeAt(t + 1)) {
                    let o = t;
                    for (let r = t + 2; r < e.length; r++)
                        if (((n = e.charCodeAt(r)), 92 === n)) r += 1;
                        else if (42 === n && 47 === e.charCodeAt(r + 1)) {
                            t = r + 1;
                            break;
                        }
                    let a = e.slice(o, t + 1);
                    if (33 === a.charCodeAt(2)) {
                        let e = Z(a.slice(2, -2));
                        (i.push(e),
                            r &&
                                ((e.src = [r, o, t + 1]),
                    ...
                    if (
                        ...
                        (32 === n ||
                            n === k ||
                            9 === n ||
                            (13 === n && (n = e.charCodeAt(t + 2)) && n == k))
                    )
                        continue;
                    if (f === k) {
                        if (0 === c.length) continue;
                        ((n = c.charCodeAt(c.length - 1)),
                            32 !== n && n !== k && 9 !== n && (c += " "));
                    } else if (
                        45 === f &&
                        45 === e.charCodeAt(t + 1) &&
                        ...
                        let i = "",
                            a = t,
                            s = -1;
                        for (let o = t + 2; o < e.length; o++)
                            if (((n = e.charCodeAt(o)), 92 === n)) o += 1;
                            else if (39 === n || 34 === n) o = $(e, o, n, r);
                            else if (47 === n && 42 === e.charCodeAt(o + 1)) {
                                for (let t = o + 2; t < e.length; t++)
                                    if (((n = e.charCodeAt(t)), 92 === n))
                                        t += 1;
                                    else if (
                                        42 === n &&
                                        47 === e.charCodeAt(t + 1)
                        ...
                        (r && ((u.src = [r, a, t]), (u.dst = [r, a, t])),
                            l ? l.nodes.push(u) : o.push(u),
                            (c = ""));
                    } else if (59 === f && 64 === c.charCodeAt(0))
                        ((s = y(c)),
                            r && ((s.src = [r, d, t]), (s.dst = [r, d, t])),
                            l ? l.nodes.push(s) : o.push(s),
                            (c = ""),
                            (s = null));
                    else if (59 === f && ")" !== u[u.length - 1]) {
                        let e = x(c);
                        if (!e) {
                            if (0 === c.length) continue;
                            throw new w(
                        ...
                        (r && ((e.src = [r, d, t]), (e.dst = [r, d, t])),
                            l ? l.nodes.push(e) : o.push(e),
                            (c = ""));
                    } else if (123 === f && ")" !== u[u.length - 1])
                        ((u += "}"),
                            (s = H(c.trim())),
                            r && ((s.src = [r, d, t]), (s.dst = [r, d, t])),
                            l && l.nodes.push(s),
                        ...
                        if (0 === c.length && (32 === f || f === k || 9 === f))
                            continue;
                        ("" === c && (d = t), (c += String.fromCharCode(f)));
                    }
                }
        }
        if (64 === c.charCodeAt(0)) {
            let t = y(c);
            (r && ((t.src = [r, d, e.length]), (t.dst = [r, d, e.length])),
                o.push(t));
        }
        if (u.length > 0 && l) {
            if ("rule" === l.kind)
                throw new w(
                    `Missing closing } at ${l.selector}`,
                    l.src ? [l.src[0], l.src[1], l.src[1]] : null,
                );
            if ("at-rule" === l.kind)
                throw new w(
                    `Missing closing } at ${l.name} ${l.params}`,
                    l.src ? [l.src[0], l.src[1], l.src[1]] : null,
                );
        }
        return i.length > 0 ? i.concat(o) : o;
    }
    function y(e, t = []) {
        let r = e,
            n = "";
        ...
        return P(r.trim(), n.trim(), t);
    }
    function x(e, t = e.indexOf(":")) {
        if (-1 === t) return null;
    ...
    function $(e, t, r, n = null) {
        let o;
        for (let i = t + 1; i < e.length; i++)
            if (((o = e.charCodeAt(i)), 92 === o)) i += 1;
            else {
                if (o === r) return i;
                if (
                    59 === o &&
                    ...
                    throw new w(
                        `Unterminated string: ${e.slice(t, i + 1) + String.fromCharCode(r)}`,
                        n ? [n, t, i + 1] : null,
                    );
                if (o === k || (13 === o && e.charCodeAt(i + 1) === k))
                    throw new w(
                        `Unterminated string: ${e.slice(t, i) + String.fromCharCode(r)}`,
                        n ? [n, t, i + 1] : null,
                    );
            }
        return t;
    ...
    function C(e, t) {
        return (S.get(t) ?? []).some((t) => e === t || e.startsWith(`${t}-`));
    }
    var T = class {
    ...
    function U(e) {
        ...
        return (i.length > 0 && r.push(E(i)), r);
    }
    var W,
        R =
            (((W = R || {})[(W.Continue = 0)] = "Continue"),
            (W[(W.Skip = 1)] = "Skip"),
            (W[(W.Stop = 2)] = "Stop"),
    ...
    function B(e, t = () => D.Continue, r = () => D.Continue) {
        ...
        for (; null !== n; ) {
            ...
            if (((o.parent = l), (o.siblings = i), a >= 0)) {
                o.index = a;
                let r = i[a],
                    l = t(r, o) ?? D.Continue;
                switch (l.kind) {
                    ...
                    default:
                        throw new Error(
                            `Invalid \`WalkAction.${R[l.kind] ?? `Unknown(${l.kind})`}\` in enter.`,
                        );
                }
            }
            let s = ~a;
            o.index = s;
            let c = r(i[s], o) ?? D.Continue;
            switch (c.kind) {
                case 0:
                    e[1] = s + 1;
                    continue;
                ...
                default:
                    throw new Error(
                        `Invalid \`WalkAction.${R[c.kind] ?? `Unknown(${c.kind})`}\` in exit.`,
                    );
            }
        }
    }
    ...
    function H(e, t = []) {
        return e.charCodeAt(0) === I ? y(e, t) : q(e, t);
    }
    function Y(e, t, r = !1) {
    ...
    function ee(e, t, r = 3) {
        ...
        function m(e, l, s = {}, c = 0) {
            if ("declaration" === e.kind) {
                if (
                    ...
                    return;
                if (s.theme && "-" === e.property[0] && "-" === e.property[1]) {
                    if ("initial" === e.value) return void (e.value = void 0);
                    s.keyframes || i.get(l).add(e);
                }
                if (e.value.includes("var("))
                    if (
                        ...
                        for (let t of _(e.value)) h.get(t).add(e.property);
                    else t.trackUsedVariables(e.value);
                if ("animation" === e.property)
                    for (let t of ae(e.value)) d.add(t);
                (2 & r &&
                    !s.supportsColorMix &&
                    !s.keyframes &&
                ...
                let t = [];
                for (let r of e.nodes) m(r, t, s, c + 1);
                t.length > 0 && l.push({ ...e, nodes: t });
            } else if (
                "at-rule" === e.kind &&
                "@property" === e.name &&
                0 === c
                        ...
                        "declaration" === t.kind &&
                            ("initial-value" === t.property
                                ...
                                : "inherits" === t.property &&
                                  (n = "true" === t.value));
                    let o = Y(t, r ?? "initial");
                    ((o.src = e.src), n ? f.push(o) : p.push(o));
                }
                o.add(e.params);
                let t = { ...e, nodes: [] };
                for (let r of e.nodes) m(r, t.nodes, s, c + 1);
                l.push(t);
                ...
                "@keyframes" === e.name
                    ...
                    : "@supports" === e.name &&
                      ...
                      (s = { ...s, supportsColorMix: !0 });
                let t = { ...e, nodes: [] };
                for (let r of e.nodes) m(r, t.nodes, s, c + 1);
                ("@keyframes" === e.name && s.theme && u.add(t),
                    (t.nodes.length > 0 ||
                        "@layer" === t.name ||
                        "@charset" === t.name ||
                        "@custom-media" === t.name ||
                ...
                for (let t of e.nodes) m(t, l, { ...s, ...e.context }, c);
            } else "comment" === e.kind && l.push(e);
        }
        let v = [];
        for (let t of e) m(t, v, {}, 0);
        e: for (let [e, r] of i)
            for (let n of r) {
                if (ie(n.property, t.theme, h)) {
                    if (n.property.startsWith(t.theme.prefixKey("--animate-")))
                        for (let e of ae(n.value)) d.add(e);
                    continue;
                }
                let r = e.indexOf(n);
                if ((e.splice(r, 1), 0 === e.length)) {
                    let t = oe(v, (t) => "rule" === t.kind && t.nodes === e);
        ...
        if (1 & r) {
            ...
            if (f.length > 0) {
                let t = H(":root, :host", f);
                ((t.src = f[0].src), e.push(t));
            }
            if (p.length > 0) {
                let t = H("*, ::before, ::after, ::backdrop", p);
                ((t.src = p[0].src), e.push(t));
            }
            if (e.length > 0) {
                let t = v.findIndex(
                        (e) =>
                    ...
                    r = P("@layer", "properties", []);
                ((r.src = e[0].src), v.splice(t < 0 ? v.length : t, 0, r));
                ...
                ((n.src = e[0].src), (n.nodes[0].src = e[0].src), v.push(n));
            }
        }
        return (function (e) {
            let t = new j(g),
                            ...
                            if (((o = null), 0 === r.length))
                                if (e.selector.includes("&")) {
                                    ...
                                    (L(t, (e) => {
                                        ...
                                        n
                                            ? r.push([c(t), e.src, e.dst])
                                            : r.push([
                                                  e.selector,
                                                  e.src,
                                                  e.dst,
                                              ]));
                                } else r.push([e.selector, e.src, e.dst]);
                            else {
                                if ("&" === e.selector) return void d.add(e);
                                let n = r[r.length - 1][0],
                                    o = V(e.selector, ",")
                                        .map((e) => {
                                            if (!e.includes("&")) {
                                                let r = t.get(n);
                                                return `${1 === r.length && "list" === r[0].kind ? `:is(${n})` : n} ${e}`;
                                            }
                                            {
                                                let r = g(e),
                                                    o = !1;
                                                if (
                                                    ...
                                                    return c(r);
                                                let i = t.get(n);
                                                return `${1 === i.length && "list" === i[0].kind ? `:is(${n})` : n} ${e}`;
                                            }
                                        })
                                        .join(", ");
                                r.push([o, e.src, e.dst]);
                            }
                            if (e.nodes.some((e) => "declaration" === e.kind)) {
                                for (let t of e.nodes) f(t);
                                return D.Skip;
                            }
                            break;
                        case "at-rule":
                            if (
                                ((o = null),
                                0 === e.nodes.length && !re.has(e.name))
                            )
                                return (f(e), d.add(e), D.Skip);
                            if (!te.has(e.name))
                                return (f(e), d.add(e), D.Skip);
                            n.push([e.name, e.params, e.src, e.dst]);
                            break;
                        case "declaration":
                        case "comment":
                            f(e);
            ...
            for (let e of a) {
                ...
                for (let r = e.length - 1; r >= 0; --r) {
                    let n = e[r];
                    if ("declaration" !== n.kind) continue;
                    let o = `${n.property}\0${n.value}\0${n.important}`;
                    t.has(o) ? e.splice(r, 1) : t.add(o);
                }
            }
            return u;
            function f(e) {
                if (o)
                    return (
                        "declaration" === e.kind &&
                            (i.has(e.property) ? a.add(o) : i.add(e.property)),
                        void o.push(e)
                    );
                {
                    ...
                    ((o = [e]),
                        i.clear(),
                        "declaration" === e.kind && i.add(e.property));
                    let t = null,
                        l = u,
                        s = 0;
                    {
                    ...
                    if (r.length > 0) {
                        let [e, i, c] = r[r.length - 1];
                        if (n.length - s <= 0) {
                            let t = l[l.length - 1];
                            if (t && "rule" === t.kind && t.selector === e)
                                return (
                                    t.nodes.push(...o),
                                    (o = t.nodes),
                                    void a.add(o)
                        ...
                        ((t = H(e, o)),
                            (i || c) && Object.assign(t, { src: i, dst: c }));
                    }
                    for (let e = n.length - 1; e >= s; --e) {
                        let [r, i, a, l] = n[e];
                        ((t = P(r, i, t ? [t] : o)),
                            (a || l) && Object.assign(t, { src: a, dst: l }));
                    }
                    t ? l.push(t) : l.push(...o);
                }
            }
    ...
    function oe(e, t) {
        ...
        return (
            L(e, (e, n) => {
                if (t(e)) return ((r = n.path()), r.push(e), D.Stop);
            }),
            r
        );
    }
    function ie(e, t, r, n = new Set()) {
        if (n.has(e) || (n.add(e), 24 & t.getOptions(e))) return !0;
        {
            let o = r.get(e) ?? [];
            for (let e of o) if (ie(e, t, r, n)) return !0;
        }
        return !1;
    }
    function ae(e) {
    ...
    function se(e) {
        return -1 !== e.indexOf("(") && le.some((t) => e.includes(`${t}(`));
    }
    function ce(e) {
        if (!le.some((t) => e.includes(t))) return e;
        let t = "",
            r = [],
            n = null,
            o = null;
    ...
    function ue(e) {
        if (-1 === e.indexOf("(")) return de(e);
        let t = U(e);
        return (fe(t), (e = ce((e = F(t)))));
    }
    function de(e, t = !1) {
        let r = "";
                    ...
                    if (
                        ...
                        for (let e = 0; e < t.nodes.length; e++)
                            0 != e || "word" !== t.nodes[e].kind
                                ? fe([t.nodes[e]])
                                : (t.nodes[e].value = de(t.nodes[e].value, !0));
                        break;
                    }
                    ((t.value = de(t.value)), fe(t.nodes));
                    break;
                case "separator":
                case "word":
                    t.value = de(t.value);
    ...
    function ve(e) {
        if ("[" === e[0] && "]" === e[e.length - 1]) {
            let t = ue(e.slice(1, -1));
            return me(t) && 0 !== t.length && 0 !== t.trim().length
                ? { kind: "arbitrary", value: t }
                : null;
        }
        return "(" === e[0] && ")" === e[e.length - 1]
            ? "-" === (e = e.slice(1, -1))[0] && "-" === e[1] && me(e)
                ? { kind: "arbitrary", value: ue((e = `var(${e})`)) }
                : null
            : ge.test(e)
              ? { kind: "named", value: e }
              : null;
        ...
        return (
            L(t, (e, t) => {
                if ("word" === e.kind && n.has(e.value)) {
                    let e = t.index;
                    if (-1 === e) return;
                    let o = t.siblings[e - 1];
                    if ("separator" !== o?.kind || " " !== o.value) return;
                    let i = t.siblings[e + 1];
                    if ("separator" !== i?.kind || " " !== i.value) return;
                    let a = t.siblings[e - 2];
                    if (a && n.has(a.value)) return;
                    let l = t.siblings[e + 2];
                    ...
                    (t.siblings[0] === e ||
                        t.siblings[t.siblings.length - 1] === e) &&
                        r.add(e);
                    ...
                    let r = t.index;
                    if (r <= 0) return;
                    let o = t.siblings[r - 1];
                    if ("separator" === o?.kind && "," === o.value) return;
                    let i = t.siblings[r - 2];
                    return i && !n.has(i.value)
                        ? void 0
                        : D.ReplaceSkip({
                              kind: "function",
                              value: "",
            ...
            r.size > 0 &&
                L(t, (e) => {
                    if (r.has(e)) return (r.delete(e), D.ReplaceSkip([]));
                }),
            ze(t),
            F(t)
        );
    ...
    var Ke = /^(?<value>[-+]?(?:\d*\.)?\d+)(?<unit>[a-z]+|%)?$/i,
        Ve = new j((e) => {
            let t = Ke.exec(e);
            if (!t) return null;
            let r = t.groups?.value;
            if (void 0 === r) return null;
            let n = Number(r);
            if (Number.isNaN(n)) return null;
            let o = t.groups?.unit;
            return void 0 === o ? [n, null] : [n, o];
        }),
        Ee = new Set([
            "black",
            "silver",
        ...
        Ne =
            /^(rgba?|hsla?|hwb|color|(ok)?(lab|lch)|light-dark|color-mix|--alpha)\(/i;
    var Oe = {
        color: function (e) {
            return (
                35 === e.charCodeAt(0) || Ne.test(e) || Ee.has(e.toLowerCase())
            );
        },
        length: Ye,
        percentage: Ie,
        ratio: function (e) {
            return qe.test(e) || se(e);
        },
        number: Me,
        integer: Je,
        url: We,
        ...
        "bg-size": function (e) {
            ...
            for (let r of V(e, ",")) {
                ...
                e.every((e) => "auto" === e || Ye(e) || Ie(e)) && (t += 1);
            }
            return t > 0;
        },
    ...
    var Re = /^(?:element|image|cross-fade|image-set)\(/,
        De = /^(repeating-)?(conic|linear|radial)-gradient\(/;
    var Le = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
        Be = new RegExp(`^${Le.source}$`);
    function Me(e) {
        return Be.test(e) || se(e);
    }
    var _e = new RegExp(`^${Le.source}%$`);
    function Ie(e) {
        return _e.test(e) || se(e);
    }
    var qe = new RegExp(`^${Le.source}\\s*/\\s*${Le.source}$`);
    var Pe = new RegExp(
            `^${Le.source}(${["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"].join("|")})$`,
        ),
        He = /^(--spacing)\(/i;
    function Ye(e) {
        return Pe.test(e) || He.test(e) || se(e);
    }
    var Ze = new RegExp(
        `^${Le.source}(${["deg", "rad", "grad", "turn"].join("|")})$`,
    );
    var Ge = new RegExp(`^${Le.source} +${Le.source} +${Le.source}$`);
    function Je(e) {
        let t = Number(e);
    ...
    var rt = new Set(["inset", "inherit", "initial", "revert", "unset"]),
        nt = new Set(["calc", "clamp", "max", "min", "--spacing"]),
        ot = new Set([
            "color",
            "color-mix",
            "contrast-color",
            ...
            .map((e) => {
                ...
                return (
                    L(n, (e) => {
                        switch (e.kind) {
                            case "word":
                                if (rt.has(e.value.toLowerCase()))
                                    return D.Continue;
                                if (it.test(e.value.toLowerCase()))
                                    return (a++, D.Continue);
                                if (
                                    "#" === e.value[0] ||
                                    (function (e) {
                                    ...
                                    return ((l = !0), D.ReplaceStop(r(e)));
                                ((o = e), i++);
                                break;
                            case "function":
                                return ot.has(e.value.toLowerCase())
                                    ? ((l = !0), D.ReplaceStop(r(e)))
                                    : nt.has(e.value.toLowerCase())
                                      ? (a++, D.Skip)
                                      : ((o = e), i++, D.Skip);
                            case "separator":
                                return D.Continue;
    ...
    function ft(e, t, r) {
        if (!t) return e;
        if ("arbitrary" === t.kind) return ut(e, t.value);
        let n = r.resolve(t.value, ["--opacity"]);
        return n ? ut(e, n) : et(t.value) ? ut(e, `${t.value}%`) : null;
    }
    function pt(e, t, r) {
        let n = null;
        ...
        return n ? ft(n, e.modifier, t) : null;
    }
    var ht = /(\d+)_(\d+)/g;
    ...
    function gt(e) {
        ...
        return (function (e) {
                  ...
                  (L(e.nodes, (e) => {
                          ...
                          for (let t of e.nodes)
                              if (
                                  ...
                                  if (
                                      ...
                                      console.warn(
                                          `Unsupported bare value data type: "${t.value}".\nOnly valid data types are: ${mt.map((e) => `"${e}"`).join(", ")}.\n`,
                                      );
                                      let r = t.value,
                                          n = structuredClone(e),
                                          o = "¶";
                                      L(n.nodes, (e) => {
                                          if (
                                              ...
                                              return D.ReplaceSkip({
                                                  kind: "word",
                                                  value: o,
                                              });
                                      });
                                      let i = "^".repeat(F([t]).length),
                                          a = F([n]).indexOf(o),
                                          l = [
                                              "```css",
                                              F([e]),
                      ...
                      r.utilities.suggest(t.slice(0, -2), () => {
                          ...
                          for (let [
                              ...
                              if (a) o.push(...lt);
                              else if (l) for (let e of lt) Je(e) && o.push(e);
                              for (let e of r.theme.keysInNamespaces(s))
                                  o.push(
                                      e.replace(ht, (e, t, r) => `${t}.${r}`),
                                  );
                          }
            ...
            : (function (e) {
              ...
              ? (r) => {
                    r.utilities.static(t, () => e.nodes.map(X));
                }
              : null;
    }
    function vt(e, t, r) {
                ...
                if (
                    ...
                    if (t.endsWith("-*")) {
                        ...
                        if (i) {
                            ...
                            {
                                let t = e[n.pop()];
                                if (t) return { nodes: U(t) };
                            }
                        }
                    }
                } else {
                    if ("named" === e.kind && "word" === n.kind) {
                        if (!mt.includes(n.value)) continue;
                        let t =
                        ...
                        if (null === r) continue;
                        if ("ratio" === r) {
                            let [e, r] = V(t, "/").map(Number);
                            if (!Je(e) || !Je(r)) continue;
                        } else {
                            if ("number" === r && !Qe(t)) continue;
                            if ("percentage" === r && !Je(t.slice(0, -1)))
                                continue;
                        }
                        if ("ratio" === r) {
                            let [e, r] = V(t, "/");
                            return {
                                nodes: U(`${e.trim()} / ${r.trim()}`),
                                ratio: !0,
                            };
                        }
                        return { nodes: U(t), ratio: !1 };
                    }
                    if (
                        "arbitrary" === e.kind &&
                        "word" === n.kind &&
    ...
    function kt(e, t, r, n, o = "") {
        ...
        return i
            ? [
                  Y(e, l(at(t, n))),
                  H("@supports (color: lab(from red l a b))", [Y(e, l(a))]),
              ]
            : [Y(e, l(a))];
    }
        ...
        return i
            ? [
                  Y(
                      ...
                      o +
                          V(t, ",")
                              .map((e) => `drop-shadow(${at(e, n)})`)
                              .join(" "),
                  ),
                  H("@supports (color: lab(from red l a b))", [Y(e, o + a)]),
              ]
            : [Y(e, o + a)];
    }
    var bt = /^-?[a-z][a-zA-Z0-9_-]*/,
        yt = 37,
        xt = 47,
        $t = 46,
        zt = 97,
    ...
    function Ot(e, t) {
        ...
        return (
            L(e, (e) => {
                if ("declaration" === e.kind && e.value && Nt.test(e.value))
                    return ((r |= 8), void (e.value = Ft(e.value, e, t)));
                "at-rule" === e.kind &&
                    ("@media" === e.name ||
                        "@custom-media" === e.name ||
                        "@container" === e.name ||
    ...
    function Ft(e, t, r) {
        ...
        return (
            L(n, (e) => {
                if ("function" === e.kind && e.value in Et) {
                    let n = V(F(e.nodes).trim(), ",").map((e) => e.trim()),
                        o = Et[e.value](r, t, ...n);
                    return D.Replace(U(o));
                }
            }),
            F(n)
        );
    ...
    function Ut(e) {
        ...
        return t !== n
            ? null
            : { attribute: o, operator: i, quote: s, value: l, sensitivity: c };
    }
    function Wt(e) {
        switch (e) {
            case 32:
            ...
            fromAst(e, t, r) {
                ...
                (L(t, (e) => {
                    ...
                    this.static(
                        ...
                        (e) => {
                            let n = t.map(X);
                            (o && _t(n, r), Mt(n, e.nodes), (e.nodes = n));
                        },
                        { compounds: Lt(n) },
                    ));
            }
        ...
        L(e, (e) =>
            "at-rule" === e.kind && "@slot" === e.name
                ...
                : "at-rule" !== e.kind ||
                  ...
                  ? void 0
                  : (Object.assign(e, J([P(e.name, e.params, e.nodes)])),
                    D.Skip),
        );
    }
    function _t(e, t) {
        ...
        return (
            L(e, (e) => {
                ...
                for (let [r, i] of o.entries()) {
                    let a = q(
                            "&",
                            r === o.length - 1 ? e.nodes : e.nodes.map(X),
                        ),
                        l = V(i, ":");
                    for (let e = l.length - 1; e >= 0; --e) {
                        ...
                        if (null === Ht(a, n, t.variants))
                            throw new Error(
                                `Cannot use \`@variant\` with variant: ${r}`,
                            );
                    }
                    "&" === a.selector ? n.push(...a.nodes) : n.push(a);
                }
                return ((r |= 32), D.Replace(n));
            }),
            r
        );
    }
    function It(e, t) {
        let r = (function (e) {
                ...
                (n("isolate", [["isolation", "isolate"]]),
                    ...
                    o("z", {
                        ...
                        staticValues: { auto: [Y("z-index", "auto")] },
                    }),
                    r("z", () => [
                        {
                            supportsNegative: !0,
                    ...
                    o("col", {
                        ...
                        staticValues: { auto: [Y("grid-column", "auto")] },
                    }),
                    o("col-span", {
                        handleBareValue: ({ value: e }) => (Je(e) ? e : null),
                        handle: (e) => [
                            Y("grid-column", `span ${e} / span ${e}`),
                        ],
                        staticValues: { full: [Y("grid-column", "1 / -1")] },
                    }),
                    o("col-start", {
                        supportsNegative: !0,
                        handleBareValue: ({ value: e }) => (Je(e) ? e : null),
                    ...
                    o("col-end", {
                        ...
                        staticValues: { auto: [Y("grid-column-end", "auto")] },
                    }),
                    r("col-span", () => [
                        {
                            values: Array.from(
                    ...
                    o("row", {
                        ...
                        staticValues: { auto: [Y("grid-row", "auto")] },
                    }),
                    o("row-span", {
                        themeKeys: [],
                        handleBareValue: ({ value: e }) => (Je(e) ? e : null),
                        handle: (e) => [Y("grid-row", `span ${e} / span ${e}`)],
                        staticValues: { full: [Y("grid-row", "1 / -1")] },
                    }),
                    o("row-start", {
                        supportsNegative: !0,
                        handleBareValue: ({ value: e }) => (Je(e) ? e : null),
                        ...
                        staticValues: { auto: [Y("grid-row-start", "auto")] },
                    }),
                    o("row-end", {
                        supportsNegative: !0,
                        handleBareValue: ({ value: e }) => (Je(e) ? e : null),
                        ...
                        staticValues: { auto: [Y("grid-row-end", "auto")] },
                    }),
                    r("row-span", () => [
                        {
                            values: Array.from(
                ...
                (n("box-border", [["box-sizing", "border-box"]]),
                    ...
                    o("line-clamp", {
                        ...
                        staticValues: {
                            none: [
                                Y("overflow", "visible"),
                                Y("display", "block"),
                                Y("-webkit-box-orient", "horizontal"),
                                Y("-webkit-line-clamp", "unset"),
                            ],
                        },
                    }),
                    r("line-clamp", () => [
                    ...
                    o("aspect", {
                        ...
                        handleBareValue: ({ fraction: e }) => {
                            ...
                            let [t, r] = V(e, "/");
                            return Qe(t) && Qe(r) ? e : null;
                        },
                        handle: (e) => [Y("aspect-ratio", e)],
                        staticValues: {
                            auto: [Y("aspect-ratio", "auto")],
                            square: [Y("aspect-ratio", "1 / 1")],
                        },
                    }));
                for (let [e, t] of [
                    ["full", "100%"],
                ...
                for (let [e, t, r] of [
                    ...
                    a(e, t, (e) => [Y(r, e)], { supportsFractions: !0 });
                for (let [e, t] of [
                    ["full", "100%"],
                    ["min", "min-content"],
                    ["max", "max-content"],
                    ...
                    t.functional("flex", (e) => {
                        if (e.value) {
                            if ("arbitrary" === e.value.kind)
                                return e.modifier
                                    ? void 0
                                    : [Y("flex", e.value.value)];
                            if (e.value.fraction) {
                                let [t, r] = V(e.value.fraction, "/");
                                return Je(t) && Je(r)
                                    ? [
                                          Y(
                                              "flex",
                ...
                let l = () =>
                    J([
                        ct("--tw-border-spacing-x", "0", "<length>"),
                        ct("--tw-border-spacing-y", "0", "<length>"),
                    ]);
                (a("border-spacing", ["--border-spacing", "--spacing"], (e) => [
                    ...
                    o("origin", {
                        ...
                        staticValues: {
                            center: [Y("transform-origin", "center")],
                            top: [Y("transform-origin", "top")],
                            "top-right": [Y("transform-origin", "100% 0")],
                            right: [Y("transform-origin", "100%")],
                            "bottom-right": [
                                Y("transform-origin", "100% 100%"),
                            ],
                            bottom: [Y("transform-origin", "bottom")],
                            "bottom-left": [Y("transform-origin", "0 100%")],
                            left: [Y("transform-origin", "0")],
                            "top-left": [Y("transform-origin", "0 0")],
                        },
                    }),
                    o("perspective-origin", {
                        ...
                        staticValues: {
                            center: [Y("perspective-origin", "center")],
                            top: [Y("perspective-origin", "top")],
                            "top-right": [Y("perspective-origin", "100% 0")],
                            right: [Y("perspective-origin", "100%")],
                            "bottom-right": [
                                Y("perspective-origin", "100% 100%"),
                            ],
                            bottom: [Y("perspective-origin", "bottom")],
                            "bottom-left": [Y("perspective-origin", "0 100%")],
                            left: [Y("perspective-origin", "0")],
                            "top-left": [Y("perspective-origin", "0 0")],
                        },
                    }),
                    o("perspective", {
                        themeKeys: ["--perspective"],
                        handle: (e) => [Y("perspective", e)],
                        staticValues: { none: [Y("perspective", "none")] },
                    }));
                let s = () =>
                    J([
                        ct("--tw-translate-x", "0"),
                ...
                function d({ negative: t }) {
                    return (r) => {
                        ...
                        if ("arbitrary" === r.value.kind) {
                            ...
                            if ("vector" === e)
                                return [Y("rotate", `${n} var(--tw-rotate)`)];
                            if ("angle" !== e)
                ...
                let p = () =>
                    J([ct("--tw-scroll-snap-strictness", "proximity", "*")]);
                ...
                for (let [e, t] of [
                    ...
                    a(e, ["--scroll-margin", "--spacing"], (e) => [Y(t, e)], {
                        supportsNegative: !0,
                    });
                for (let [e, t] of [
                    ...
                    a(e, ["--scroll-padding", "--spacing"], (e) => [Y(t, e)]);
                (n("list-inside", [["list-style-position", "inside"]]),
                    ...
                    o("list", {
                        ...
                        staticValues: {
                            none: [Y("list-style-type", "none")],
                            disc: [Y("list-style-type", "disc")],
                            decimal: [Y("list-style-type", "decimal")],
                        },
                    }),
                    o("list-image", {
                        themeKeys: ["--list-style-image"],
                        handle: (e) => [Y("list-style-image", e)],
                        staticValues: { none: [Y("list-style-image", "none")] },
                    }),
                    ...
                    o("columns", {
                        ...
                        staticValues: { auto: [Y("columns", "auto")] },
                    }),
                    r("columns", () => [
                        {
                            values: Array.from(
                ...
                (n("grid-flow-row", [["grid-auto-flow", "row"]]),
                    ...
                    o("auto-cols", {
                        ...
                        staticValues: {
                            auto: [Y("grid-auto-columns", "auto")],
                            min: [Y("grid-auto-columns", "min-content")],
                            max: [Y("grid-auto-columns", "max-content")],
                            fr: [Y("grid-auto-columns", "minmax(0, 1fr)")],
                        },
                    }),
                    o("auto-rows", {
                        ...
                        staticValues: {
                            auto: [Y("grid-auto-rows", "auto")],
                            min: [Y("grid-auto-rows", "min-content")],
                            max: [Y("grid-auto-rows", "max-content")],
                            fr: [Y("grid-auto-rows", "minmax(0, 1fr)")],
                        },
                    }),
                    o("grid-cols", {
                        themeKeys: ["--grid-template-columns"],
                        handleBareValue: ({ value: e }) =>
                            Xe(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
                        handle: (e) => [Y("grid-template-columns", e)],
                        staticValues: {
                            none: [Y("grid-template-columns", "none")],
                            subgrid: [Y("grid-template-columns", "subgrid")],
                        },
                    }),
                    o("grid-rows", {
                        ...
                        staticValues: {
                            none: [Y("grid-template-rows", "none")],
                            subgrid: [Y("grid-template-rows", "subgrid")],
                        },
                    }),
                    r("grid-cols", () => [
                        {
                    ...
                    n("scrollbar-none", [["scrollbar-width", "none"]]));
                {
                    let e = () =>
                        J([
                            ct("--tw-scrollbar-thumb", "#0000", "<color>"),
                            ct("--tw-scrollbar-track", "#0000", "<color>"),
                        ]);
                    (i("scrollbar-thumb", {
                        themeKeys: ["--color"],
                        handle: (t) => [
                            e(),
                            Y("--tw-scrollbar-thumb", t),
                            Y(
                                "scrollbar-color",
                ...
                for (let [e, t] of [
                    ...
                    o(e, {
                        ...
                        staticValues: {
                            none: t.map((e) => Y(e, "0")),
                            full: t.map((e) => Y(e, "calc(infinity * 1px)")),
                        },
                    });
                (n("border-solid", [
                    ...
                    (i("border", {
                        ...
                        i("border-bs", {
                            width: (e) => [
                                ...
                                Y("border-block-start-width", e),
                            ],
                            color: (e) => [Y("border-block-start-color", e)],
                        }),
                        i("border-be", {
                            width: (e) => [
                                Y(
                                ...
                                Y("border-block-end-width", e),
                            ],
                            color: (e) => [Y("border-block-end-color", e)],
                        }),
                        i("border-t", {
                            width: (e) => [
                        ...
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (
                                ...
                                case "url":
                                    return t.modifier
                                        ? void 0
                                        : [Y("background-image", r)];
                                default:
                                    return (
                                        (r = ft(r, t.modifier, e)),
                                        null === r
                                            ? void 0
                                            : [Y("background-color", r)]
                                    );
                            }
                        }
                        {
                            let r = pt(t, e, ["--background-color", "--color"]);
                ...
                let h = () =>
                    J([
                        ct("--tw-gradient-position"),
                        ct("--tw-gradient-from", "#0000", "<color>"),
                        ct("--tw-gradient-via", "#0000", "<color>"),
                        ct("--tw-gradient-to", "#0000", "<color>"),
                        ct("--tw-gradient-stops"),
                        ct("--tw-gradient-via-stops"),
                        ct(
                ...
                let g = () =>
                    J([
                        ct("--tw-mask-linear", "linear-gradient(#fff, #fff)"),
                        ct("--tw-mask-radial", "linear-gradient(#fff, #fff)"),
                        ct("--tw-mask-conic", "linear-gradient(#fff, #fff)"),
                    ]);
                function v(n, o) {
                    (t.functional(n, (t) => {
                        if (t.value) {
                            ...
                            }
                            {
                                ...
                                switch (r) {
                                    case "number":
                                        return e.resolve(null, ["--spacing"]) &&
                                            Qe(t.value.value)
                                            ? o.position(
                                                  `--spacing(${t.value.value})`,
                                              )
                                            : void 0;
                                    case "percentage":
                ...
                let k = () =>
                    J([
                        ct("--tw-mask-left", "linear-gradient(#fff, #fff)"),
                        ct("--tw-mask-right", "linear-gradient(#fff, #fff)"),
                        ct("--tw-mask-bottom", "linear-gradient(#fff, #fff)"),
                        ct("--tw-mask-top", "linear-gradient(#fff, #fff)"),
                    ]);
                function w(e, t, r) {
                    v(e, {
                        color(e) {
                ...
                let b = () =>
                    J([
                        ct("--tw-mask-linear-position", "0deg"),
                        ct("--tw-mask-linear-from-position", "0%"),
                        ct("--tw-mask-linear-to-position", "100%"),
                        ct("--tw-mask-linear-from-color", "black"),
                        ct("--tw-mask-linear-to-color", "transparent"),
                    ]);
                (o("mask-linear", {
                    defaultValue: null,
                    supportsNegative: !0,
                    ...
                    handleNegativeBareValue({ value: e }) {
                        if (!Je(e)) return null;
                        let t = Number(e);
                        return 0 === t
                            ? "0deg"
                ...
                let y = () =>
                    J([
                        ct("--tw-mask-radial-from-position", "0%"),
                        ct("--tw-mask-radial-to-position", "100%"),
                        ct("--tw-mask-radial-from-color", "black"),
                        ct("--tw-mask-radial-to-color", "transparent"),
                        ct("--tw-mask-radial-shape", "ellipse"),
                        ct("--tw-mask-radial-size", "farthest-corner"),
                        ct("--tw-mask-radial-position", "center"),
                    ]);
                ...
                let x = () =>
                    J([
                        ct("--tw-mask-conic-position", "0deg"),
                        ct("--tw-mask-conic-from-position", "0%"),
                        ct("--tw-mask-conic-to-position", "100%"),
                        ct("--tw-mask-conic-from-color", "black"),
                        ct("--tw-mask-conic-to-color", "transparent"),
                    ]);
                (o("mask-conic", {
                    defaultValue: null,
                    supportsNegative: !0,
                ...
                (n("mix-blend-plus-darker", [
                    ...
                    t.functional("fill", (t) => {
                        if (!t.value) return;
                        if ("arbitrary" === t.value.kind) {
                            let r = ft(t.value.value, t.modifier, e);
                            return null === r ? void 0 : [Y("fill", r)];
                        }
                        let r = pt(t, e, ["--fill", "--color"]);
                    ...
                    o("object", {
                        ...
                        staticValues: {
                            top: [Y("object-position", "top")],
                            "top-left": [Y("object-position", "left top")],
                            "top-right": [Y("object-position", "right top")],
                            bottom: [Y("object-position", "bottom")],
                            "bottom-left": [
                            ...
                            left: [Y("object-position", "left")],
                            right: [Y("object-position", "right")],
                            center: [Y("object-position", "center")],
                        },
                    }));
                for (let [e, t] of [
                    ["p", "padding"],
                ...
                (n("text-left", [["text-align", "left"]]),
                    ...
                    o("font-features", {
                        themeKeys: [],
                        handle: (e) => [Y("font-feature-settings", e)],
                    }),
                    ...
                    o("animate", {
                        ...
                        staticValues: { none: [Y("animation", "none")] },
                    }));
                {
                    let i = [
                            "var(--tw-blur,)",
                        ...
                        l = () =>
                            J([
                                ...
                                ct("--tw-sepia"),
                                ct("--tw-drop-shadow"),
                                ct("--tw-drop-shadow-color"),
                                ct(
                                    "--tw-drop-shadow-alpha",
                                    "100%",
                                    "<percentage>",
                                ),
                                ct("--tw-drop-shadow-size"),
                            ]),
                        s = () =>
                            J([
                                ct("--tw-backdrop-blur"),
                                ct("--tw-backdrop-brightness"),
                                ct("--tw-backdrop-contrast"),
                                ct("--tw-backdrop-grayscale"),
                                ct("--tw-backdrop-hue-rotate"),
                                ct("--tw-backdrop-invert"),
                                ct("--tw-backdrop-opacity"),
                                ct("--tw-backdrop-saturate"),
                                ct("--tw-backdrop-sepia"),
                            ]);
                    (t.functional("filter", (e) => {
                        if (!e.modifier) {
                            if (null === e.value) return [l(), Y("filter", i)];
                            if ("arbitrary" === e.value.kind)
                ...
                }
                {
                    ...
                    (o("transition", {
                        ...
                        handle: (e) => [
                            ...
                            Y("transition-timing-function", i),
                            Y("transition-duration", a),
                        ],
                        staticValues: {
                            none: [Y("transition-property", "none")],
                            all: [
                                Y("transition-property", "all"),
                                Y("transition-timing-function", i),
                                Y("transition-duration", a),
                            ],
                            colors: [
                            ...
                            opacity: [
                                Y("transition-property", "opacity"),
                                Y("transition-timing-function", i),
                                Y("transition-duration", a),
                            ],
                            shadow: [
                                Y("transition-property", "box-shadow"),
                                Y("transition-timing-function", i),
                                Y("transition-duration", a),
                            ],
                            transform: [
                ...
                }
                {
                    ...
                    o("ease", {
                        ...
                        staticValues: {
                            initial: [e(), Y("--tw-ease", "initial")],
                            linear: [
                                e(),
                                Y("--tw-ease", "linear"),
                                Y("transition-timing-function", "linear"),
                            ],
                        },
                    });
                }
                    ...
                    let e =
                        ...
                        t = () =>
                            J([
                                ct("--tw-ordinal"),
                                ct("--tw-slashed-zero"),
                                ct("--tw-numeric-figure"),
                                ct("--tw-numeric-spacing"),
                                ct("--tw-numeric-fraction"),
                            ]);
                ...
                {
                    let i = () => J([ct("--tw-outline-style", "solid")]);
                ...
                (o("opacity", {
                    themeKeys: ["--opacity"],
                    handleBareValue: ({ value: e }) => (et(e) ? `${e}%` : null),
                    ...
                    o("underline-offset", {
                        ...
                        staticValues: {
                            auto: [Y("text-underline-offset", "auto")],
                        },
                    }),
                    r("underline-offset", () => [
                        {
                            ...
                            }
                            {
                                ...
                                if (r) {
                                    ...
                                    if (t.modifier) {
                                        ...
                                        if (!r && Qe(t.modifier.value)) {
                                            if (!e.resolve(null, ["--spacing"]))
                                                return null;
                                            r = `--spacing(${t.modifier.value})`;
                                        }
                                        if (
                                            (!r &&
                ...
                let $ = () =>
                    J([
                        ct("--tw-text-shadow-color"),
                        ct("--tw-text-shadow-alpha", "100%", "<percentage>"),
                    ]);
                    ...
                    let o = function (e) {
                        ...
                        s = () =>
                            J([
                                ct("--tw-shadow", l),
                                ct("--tw-shadow-color"),
                                ct("--tw-shadow-alpha", "100%", "<percentage>"),
                                ct("--tw-inset-shadow", l),
                                ct("--tw-inset-shadow-color"),
                                ct(
                                ...
                                ct("--tw-ring-color"),
                                ct("--tw-ring-shadow", l),
                                ct("--tw-inset-ring-color"),
                                ct("--tw-inset-ring-shadow", l),
                                ct("--tw-ring-inset"),
                                ct("--tw-ring-offset-width", "0px", "<length>"),
                                ct("--tw-ring-offset-color", "#fff"),
                                ct("--tw-ring-offset-shadow", l),
                            ]);
                            ...
                            if ("arbitrary" === t.value.kind) {
                                ...
                                return "length" ===
                                    ...
                                    ? t.modifier
                                        ...
                                        : [
                                              s(),
                                              Y("--tw-inset-ring-shadow", i(r)),
                                              Y("box-shadow", a),
                                          ]
                                    : ((r = ft(r, t.modifier, e)),
                                      null === r
                                          ? void 0
                                          : [Y("--tw-inset-ring-color", r)]);
                            }
                            {
                                let r = pt(t, e, ["--ring-color", "--color"]);
            ...
            n = (function (e) {
                ...
                function n(e, t) {
                    return t.map((t) => {
                        if ("@container" === e) {
                            let e = U(t.trim());
                            return e.length >= 1 && "function" === e[0].kind
                                ? `not ${t}`
                                : e.length >= 3 &&
                                    "word" === e[0].kind &&
                                    "not" === e[0].value &&
                ...
                (t.compound("not", 3, (e, t) => {
                    ...
                    return (
                        L([e], (t, n) => {
                            if ("rule" !== t.kind && "at-rule" !== t.kind)
                                return D.Continue;
                            if (t.nodes.length > 0) return D.Continue;
                            let o = [],
                                l = [],
                                s = n.path();
                            s.push(t);
                            ...
                            if (o.length > 1) return D.Stop;
                            if (l.length > 1) return D.Stop;
                            let c = [];
                            for (let e of l) {
                                let t = a(e.selector);
                                if (!t) return ((r = !1), D.Stop);
                                c.push(q(t, []));
                            }
                            for (let e of o) {
                                let t = i(e);
                    ...
                    t.compound("group", 2, (t, r) => {
                        ...
                        return (
                            L([t], (e, t) => {
                                if ("rule" !== e.kind) return D.Continue;
                                for (let e of t.path())
                                    if ("rule" === e.kind)
                                        return ((o = !1), D.Stop);
                ...
                (r("first", ["&:first-child"]),
                    ...
                    t.functional("aria", (e, t) => {
                        ...
                        if ("arbitrary" === t.value.kind) {
                            let r = `[aria-${Bt(t.value.value)}]`;
                            if (null === Ut(r)) return null;
                            e.nodes = [q(`&${r}`, e.nodes)];
                        } else {
                            let r = `[aria-${t.value.value}="true"]`;
                            if (null === Ut(r)) return null;
                            e.nodes = [q(`&${r}`, e.nodes)];
                        }
                    }),
                    ...
                    t.functional("nth", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [q(`&:nth-child(${t.value.value})`, e.nodes)];
                    }),
                    t.functional("nth-last", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            q(`&:nth-last-child(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            q(`&:nth-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional("nth-last-of-type", (e, t) => {
                        if (
                            ...
                            return null;
                        e.nodes = [
                            q(`&:nth-last-of-type(${t.value.value})`, e.nodes),
                        ];
                    }),
                    t.functional(
                        "supports",
                        (e, t) => {
                            ...
                            if (/^[\w-]*\s*\(/.test(r)) {
                                ...
                                return void (e.nodes = [
                                    P("@supports", t, e.nodes),
                                ]);
                            }
                            (r.includes(":") || (r = `${r}: var(--tw)`),
                                ("(" !== r[0] || ")" !== r[r.length - 1]) &&
                                    (r = `(${r})`),
                                (e.nodes = [P("@supports", r, e.nodes)]));
                        },
                        { compounds: 1 },
                    ),
                    r("motion-safe", [
            ...
            o = new j((e) =>
                (function (e, t) {
                    if ("[" === e[0] && "]" === e[e.length - 1]) {
                        ...
                        let t = ue(e.slice(1, -1));
                        if (!me(t) || 0 === t.length || 0 === t.trim().length)
                            return null;
                        let r = ">" === t[0] || "+" === t[0] || "~" === t[0];
                        return (
                            !r &&
            ...
            l = new j((t) => {
                for (let r of _(t)) e.markUsedVariable(r);
            });
        function s(e) {
            let r = [];
            for (let n of e) {
        ...
        let c = {
            ...
            candidatesToCss: function (e) {
                return s(e).map((e) => (e.length > 0 ? ne(e) : null));
            },
            candidatesToAst: s,
            getClassOrder(e) {
                return (function (e, t) {
                    let { astNodes: r, nodeSorting: n } = Pt(Array.from(t), e),
            ...
            printCandidate: (e) =>
                (function (e, t) {
                    let r = [];
                    for (let e of t.variants) r.unshift(be(e));
                    ...
                    if (
                        ...
                        if ("arbitrary" === t.value.kind) {
                            if (null !== t.value) {
                                let e = Se(t.value.value),
                                    r = e
                                        ? t.value.value.slice(4, -1)
                                        : t.value.value,
                                    [o, i] = e ? ["(", ")"] : ["[", "]"];
                                t.value.dataType
                                    ? (n += `-${o}${t.value.dataType}:${xe(r)}${i}`)
                                    : (n += `-${o}${xe(r)}${i}`);
                            }
                        } else
                            "named" === t.value.kind &&
    ...
    function Pt(e, t, { onInvalidCandidate: r, respectImportant: n } = {}) {
        let o = new Map(),
            i = [],
            a = new Map();
        for (let n of e) {
    ...
    function Ht(e, t, r, n = 0) {
        if ("arbitrary" === t.kind)
            return t.relative && 0 === n
                ? null
                : void (e.nodes = [H(t.selector, e.nodes)]);
        let { applyFn: o } = r.get(t.root);
        if ("compound" === t.kind) {
            let i = P("@slot");
            if (
                null === Ht(i, t.variant, r, n + 1) ||
        ...
        for (; n.length > 0; ) {
            ...
            if ("declaration" === e.kind) {
                ...
                if ("--tw-sort" === e.property) {
                    let r = qt.indexOf(e.value ?? "");
                    if (-1 !== r) {
                        (t.add(r), (o = !0));
                        continue;
                    }
                }
                let n = qt.indexOf(e.property);
                -1 !== n && t.add(n);
                    ...
                    return (
                        ...
                        void L(e.nodes, (r) => {
                            if ("at-rule" === r.kind && "@apply" === r.name) {
                                o.add(e);
                                for (let n of Xt(r, t)) i.get(e).add(n);
                            }
                        })
                    );
                }
                ...
                L(e.nodes, (e) => {
                    ...
                    for (let [e, t] of r.entries())
                        (e % 2 == 0 &&
                            ...
                            (a += t.length));
                    if (i.length) {
                        if (0 === o.length) return D.Skip;
                        let e = i.join(" ");
                        throw new Error(
                            `You cannot use \`@apply\` with both mixins and utilities. Please move \`@apply ${e}\` into a separate rule.`,
                        );
                    }
                    if (e.nodes.length > 0 && o.length) {
                        let e = o.join(" ");
                        throw new Error(
                            `The rule \`@apply ${e}\` must not have a body.`,
                        );
                    }
                    {
                        let r = Pt(Object.keys(n), t, {
                                respectImportant: !1,
    ...
    async function Qt(e, t, r, n = 0, o = !1) {
        let i = 0,
            a = [];
        return (
            L(e, (e) => {
                if (
                    ...
                    if (null === l) return;
                    ("@reference" === e.name && (l.media = "reference"),
                        (i |= 2));
                    let { uri: s, layer: c, media: u, supports: d } = l;
                    if (
                        s.startsWith("data:") ||
                        s.startsWith("http://") ||
                        s.startsWith("https://")
                    ...
                    return (
                        a.push(
                            (async () => {
                                if (n > 100)
                                    throw new Error(
                                        `Exceeded maximum recursion depth while resolving \`${s}\` in \`${t}\`)`,
                                    );
                                let i = await r(s, t),
                                    a = b(i.content, {
                                        from: o ? i.path : void 0,
                                    });
                                (await Qt(a, i.base, r, n + 1, o),
                                    (f.nodes = (function (e, t, r, n, o) {
                                        let i = t;
                                        if (null !== r) {
                                            let t = P("@layer", r, i);
                                            ((t.src = e.src), (i = [t]));
    ...
    function tr(e, { theme: t }, r) {
        ...
        if (Object.hasOwn(t, "fontFamily")) {
            let r = 5;
            {
                let n = er(t.fontFamily.sans);
                n &&
                    e.theme.hasDefault("--font-sans") &&
                    (e.theme.add("--default-font-family", n, r),
                    e.theme.add(
                        "--default-font-feature-settings",
                        er(t.fontFamily.sans, "fontFeatureSettings") ??
                            "normal",
                        r,
                    ),
                    e.theme.add(
                        "--default-font-variation-settings",
                        er(t.fontFamily.sans, "fontVariationSettings") ??
                            "normal",
                        r,
                    ));
            }
            {
                let n = er(t.fontFamily.mono);
                n &&
                    e.theme.hasDefault("--font-mono") &&
                    (e.theme.add("--default-mono-font-family", n, r),
                    e.theme.add(
                        "--default-mono-font-feature-settings",
                        er(t.fontFamily.mono, "fontFeatureSettings") ??
                            "normal",
                        r,
                    ),
                    e.theme.add(
                        "--default-mono-font-variation-settings",
                        er(t.fontFamily.mono, "fontVariationSettings") ??
                            "normal",
                        r,
                    ));
            }
    ...
    function ir(e) {
        ...
        for (let t of e) if (!or.test(t)) return null;
        let r = nr[e[0]];
        return (
            r && ((e = e.slice())[0] = r),
            e
    ...
    function ur(e, t, r) {
        return function (n, o) {
            ...
            let l = (() => {
                let o = lr(n),
                    [i, a] = (function (e, t) {
                        ...
                        let s = {},
                            c = {};
                        for (let [e, t] of n) fr(s, [e ?? "DEFAULT"], t);
                        for (let [e, t] of a) fr(c, [e ?? "DEFAULT"], t);
            ...
            return (a && "string" == typeof l && (l = ut(l, a)), l ?? o);
        };
    }
    function dr(e, t) {
    ...
    function hr({
        ...
        let a = {
            ...
            addVariant(t, r) {
                ...
                "string" == typeof r || Array.isArray(r)
                    ? e.variants.static(
                          t,
                          (e) => {
                              e.nodes = gr(r, e.nodes);
                          },
                          { compounds: Lt("string" == typeof r ? [r] : r) },
                      )
                    : "object" == typeof r && e.variants.fromAst(t, mr(r), e);
            },
            matchVariant(t, r, n) {
                function o(e, t, n) {
                    return gr(r(e, { modifier: t?.value ?? null }), n);
                }
                try {
            ...
            addUtilities(r) {
                ...
                a = a.flatMap(([e, t]) => V(e, ",").map((e) => [e.trim(), t]));
                let l = new j(() => []);
                for (let [e, r] of a) {
                ...
                if ("object" != typeof n) {
                    ...
                    for (let r of n)
                        "string" == typeof r
                            ? t.push(Y(e, r))
                            : t.push(H(e, mr(r)));
                else t.push(H(e, mr(n)));
        return t;
    }
    function gr(e, t) {
        return ("string" == typeof e ? [e] : e).flatMap((e) => {
            if (e.trim().endsWith("}")) {
                let r = b(e.replace("}", "{@slot}}"));
                return (Mt(r, t), r);
            }
            return H(e, t);
        });
    ...
    var yr = br((e) => {
        ...
        Sr = br((e) => {
            ...
            let [t, r] = V(e.fraction, "/");
            return Je(t) && Je(r) ? e.fraction : void 0;
        }),
        Cr = br((e) => {
            if (Je(Number(e.value)))
        ...
        Tr = {
            ...
            backdropContrast: ({ theme: e }) => ({ ...e("contrast"), ...xr }),
            backdropGrayscale: ({ theme: e }) => ({ ...e("grayscale"), ...xr }),
            backdropHueRotate: ({ theme: e }) => ({ ...e("hueRotate"), ...Ar }),
            backdropInvert: ({ theme: e }) => ({ ...e("invert"), ...xr }),
            backdropOpacity: ({ theme: e }) => ({ ...e("opacity"), ...xr }),
            backdropSaturate: ({ theme: e }) => ({ ...e("saturate"), ...xr }),
            backdropSepia: ({ theme: e }) => ({ ...e("sepia"), ...xr }),
            ...
            divideWidth: ({ theme: e }) => ({ ...e("borderWidth"), ...$r }),
            dropShadow: {
            ...
            flexGrow: { 0: "0", DEFAULT: "1", ...yr },
            flexShrink: { 0: "0", DEFAULT: "1", ...yr },
            fontFamily: {
                sans: [
                    "-apple-system",
                    "BlinkMacSystemFont",
    ...
    function Vr(e, t) {
        let r = {
            ...
            theme: {},
            extend: {},
            result: structuredClone(Kr),
        };
        for (let e of t) Nr(r, e);
        ...
        let n = (function (e) {
            let t = new Set(),
                r = ur(e.design, () => e.theme, o),
                n = Object.assign(r, { theme: r, colors: wr });
            function o(e) {
    ...
    function Er(e, t) {
        return Array.isArray(e) && sr(e[0])
            ? e.concat(t)
            : Array.isArray(t) && sr(t[0]) && sr(e)
              ? [e, ...t]
              : Array.isArray(t)
                ? t
                : void 0;
    }
    function Nr(e, { config: t, base: r, path: n, reference: o, src: i }) {
        let a = [];
        ...
        for (let a of t.presets ?? [])
            Nr(e, { path: n, base: r, config: a, reference: o, src: i });
        for (let t of a)
            (e.plugins.push(t),
                t.config &&
                    Nr(e, {
    ...
    function Or(e, t) {
        ...
        let n = (function ({ center: e, padding: t, screens: r }, n) {
            ...
            if (
                ...
                if ((e.sort((e, t) => je(e[1], t[1], "asc")), e.length > 0)) {
                    let [t] = e[0];
                    o.push(
                        P("@media", `(width >= --theme(--breakpoint-${t}))`, [
                            Y("max-width", "none"),
                        ]),
                    );
                }
            ...
            if ("object" == typeof t && null !== t) {
                let e = Object.entries(t)
                    ...
                    .filter(Boolean);
                e.sort((e, t) => je(e[1], t[1], "asc"));
                for (let [t, , r] of e)
                    if (i && i.has(t))
                        i.get(t).nodes.push(Y("padding-inline", r));
                    else {
                        if (i) continue;
                        o.push(
                            P("@media", `(width >= theme(--breakpoint-${t}))`, [
        ...
        0 !== n.length && t.utilities.static("container", () => n.map(X));
    }
    function Fr({ addVariant: e, config: t }) {
        ...
        (L(r, (e, t) => {
            ...
            if ("@plugin" === e.name) {
                ...
                for (let t of e.nodes ?? []) {
                    ...
                    let e = V(t.value, ",").map((e) => {
                        ...
                        if ("{" === e[0] && "}" === e[e.length - 1])
                            throw new Error(
                                `Unexpected \`@plugin\` option: Value of declaration \`${ne([t]).trim()}\` is not supported.\n\nUsing an object as a plugin option is currently only supported in JavaScript configuration files.`,
                            );
                        return e;
                    });
            ...
            (function (e) {
                ...
                (e.utilities.suggest("bg-left-top", () => []),
                    ...
                    e.utilities.static("order-none", () => [Y("order", "0")]),
                ...
                for (let [t, r] of [
                    ...
                    (e.utilities.static(`${t}-auto`, () => [Y(r, "auto")]),
                        e.utilities.static(`${t}-full`, () => [Y(r, "100%")]),
                        e.utilities.static(`-${t}-full`, () => [Y(r, "-100%")]),
                        e.utilities.static(`${t}-px`, () => [Y(r, "1px")]),
                        e.utilities.static(`-${t}-px`, () => [Y(r, "-1px")]),
    ...
    function Dr({
        ...
        let a = 0,
            ...
            { resolvedConfig: s } = Vr(e, [
                { config: jr(e.theme), base: t, reference: !0, src: void 0 },
                ...l,
                {
                    config: { plugins: [Fr] },
                    base: t,
            ...
            { resolvedConfig: c, replacedThemeKeys: u } = Vr(e, l),
            d = {
                designSystem: e,
                ast: r,
                resolvedConfig: s,
            ...
            f = hr({ ...d, referenceMode: !1, src: void 0 }),
        ...
        for (let { handler: e, reference: t, src: r } of s.plugins) {
            e(hr({ ...d, referenceMode: t ?? !1, src: r }));
        }
        if (
            (tr(e, c, u),
            kr(e, c),
    ...
    async function qr(
        ...
        let i = 0;
        ((e = [G({ base: t }, e)]), (i |= await Qt(e, t, o, 0, void 0 !== r)));
        let a = null,
            l = new T(),
            s = new Map(),
            c = new Map(),
        ...
        L(e, (e, t) => {
            ...
            if (
                ...
                if (null !== f) return D.Replace([]);
                if (r.context.reference) return D.Replace([]);
                let t = V(e.params, " ");
                for (let e of t)
            ...
            if ("@source" === e.name) {
                ...
                } else h.push({ base: r.context.base, pattern: i, negated: t });
                return D.ReplaceSkip([]);
            }
            if (
                ("@variant" === e.name &&
                    ...
                    (s.set(t, (e) => {
                        e.variants.static(
                            ...
                            (e) => {
                                let t = [];
                                o.length > 0 &&
                                    t.push(q(o.join(", "), e.nodes));
                                for (let n of r) t.push(H(n, e.nodes));
                                e.nodes = t;
                            },
                            { compounds: Lt([...o, ...r]) },
                        );
                    ...
                    if (o.startsWith("source(")) {
                        ...
                        L(e.nodes, (e) => {
                            if ("at-rule" === e.kind && "@theme" === e.name)
                                return ((e.params += ` prefix(${t})`), D.Skip);
                        });
                    } else
                        "important" === o
                            ? (a = !0)
                            : "reference" === o
                              ? (e.nodes = [G({ reference: !0 }, e.nodes)])
                              : n.push(o);
                if (n.length > 0) e.params = n.join(" ");
                else if (t.length > 0) return D.Replace(e.nodes);
                return D.Continue;
            }
            if ("@theme" === e.name) {
                let [t, n] = (function (e) {
                ...
                return (
                    L(e.nodes, (r) => {
                        if ("at-rule" === r.kind && "@keyframes" === r.name)
                            return (l.addKeyframes(r), D.Skip);
        ...
        let k = It(l, f?.src);
        if ((a && (k.important = a), g.length > 0))
            for (let e of g) k.invalidCandidates.add(e);
        i |= await Rr({
            designSystem: k,
            base: t,
            ast: e,
        ...
        for (let e of s.keys()) k.variants.static(e, () => {});
        ...
        if (d) {
            ...
            for (let t of r) e.push(G({ theme: !0 }, [J([t])]));
            d.nodes = [G({ theme: !0 }, t)];
        }
        if (((i |= _t(e, k)), (i |= Ot(e, k)), (i |= Jt(e, k)), f)) {
            let e = f;
        ...
        return (
            L(e, (e) => {
                if ("at-rule" === e.kind)
                    return "@utility" === e.name ? D.Replace([]) : D.Skip;
            }),
            {
                designSystem: k,
                ast: e,
    ...
    async function Pr(e, t = {}) {
        let r = b(e, { from: t.from }),
            n = await (async function (e, t = {}) {
                ...
                return {
                    ...
                    build(o) {
                        if (0 === l) return e;
                        if (!a) return ((d ??= ee(n, r, t.polyfills)), d);
                        let i = p,
                            s = !1;
                        p = !1;
                        let h = u.size;
                        ...
                        if (!i) return ((d ??= ee(n, r, t.polyfills)), d);
                        let m = Pt(u, r, { onInvalidCandidate: c }).astNodes;
                        return (
                            t.from &&
                                L(m, (e) => {
                                    e.src ??= a.src;
                            ...
                            s || f !== m.length
                                ? ((f = m.length),
                                  (a.nodes = m),
                                  (d = ee(n, r, t.polyfills)),
                                  d)
                                : ((d ??= ee(n, r, t.polyfills)), d)
                        );
                    },
                };
            })(r, t),
        ...
        return {
            ...
            build(e) {
                let r = n.build(e);
                return (r === o || ((i = ne(r, !!t.from)), (o = r)), i);
            },
            buildSourceMap: () =>
                (function ({ ast: e }) {
                    let t = new j((e) => v(e.code)),
                        r = new j((e) => ({
                            url: e.file,
                            content: e.code,
                            ignore: !1,
    ...
    async function rn(e, t) {
        try {
            ...
            throw (
                tn.hit("Failed to load stylesheet", {
                    id: e,
                    base: t,
                    error: r.message ?? r,
                }),
    ...
    function on(e) {
        Qr = Qr.then(async function () {
            if (!Hr && "full" !== e) return;
            let t = en++;
            (tn.start(`Build #${t} (${e})`),
                "full" === e &&
                    (await (async function () {
                        (tn.start("Create compiler"),
                            tn.start("Reading Stylesheets"));
                        let e = document.querySelectorAll(
                                `style[type="${Zr}"]`,
                            ),
                            t = "";
                        for (let r of e) (ln(r), (t += r.textContent + "\n"));
                        if (
                            (t.includes("@import") ||
                                (t = `@import "tailwindcss";${t}`),
                            tn.end("Reading Stylesheets", {
                                size: t.length,
                                changed: Jr !== t,
                            }),
                            Jr !== t)
                        ) {
                            ((Jr = t), tn.start("Compile CSS"));
                            try {
                                Hr = await Pr(t, {
                                    base: "/",
                                    loadStylesheet: rn,
                ...
                await (async function (e) {
                    if (!Hr) return;
                    let t = new Set();
                    tn.start("Collect classes");
                    for (let e of document.querySelectorAll("[class]"))
                        for (let r of e.classList)
                            Gr.has(r) || (Gr.add(r), t.add(r));
                    (tn.end("Collect classes", { count: t.size }),
                        (0 !== t.size || "incremental" !== e) &&
                            (tn.start("Build utilities"),
                            (Xr.textContent = Hr.build(Array.from(t))),
                            tn.end("Build utilities")));
                })(e),
                tn.end("Build"),
                tn.end(`Build #${t} (${e})`));
        }).catch((e) => tn.error(e));
    }
    var an = new MutationObserver(() => on("full"));
    function ln(e) {
        an.observe(e, {
            attributes: !0,
    ...
    (new MutationObserver((e) => {
        ...
        for (let n of e) {
            for (let e of n.addedNodes)
                e.nodeType === Node.ELEMENT_NODE &&
                    "STYLE" === e.tagName &&
                    e.getAttribute("type") === Zr &&
                    (ln(e), t++);
            for (let e of n.addedNodes) 1 === e.nodeType && e !== Xr && r++;
            "attributes" === n.type && r++;
        }
        return t > 0 ? on("full") : r > 0 ? on("incremental") : void 0;
        ...
        on("full"),
        document.head.append(Xr));
})();
//# sourceMappingURL=/sm/5f190017688f2b30dd0d9c5814a6088d0d5d2545a106810773899534b4dbf033.map
