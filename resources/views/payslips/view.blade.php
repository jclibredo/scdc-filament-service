    ...
    <div class="payslip-container">
        ...
        <div class="left-section">
            ...
            <div class="emp-details">
                ...
                <p><strong>Net Pay: </strong>{{ number_format($totalAmount, 2) }}</p>
            </div>
            <center>
                <div class="signature">
    ...
    <div class="payslip-container">
        ...
        <div class="right-section" style="font-size: 10px;">
            ...
            <table cellpadding="6" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- First deduction (if any) --}}
                        <td>Deductions</td>
                        <td style="text-align: left;"> {{ number_format($totalDeduction, 2) }}</td>
            ...
            <div class="totals">
                ...
                <div>Total Deduction: {{ number_format($totalDeduction, 2) }}</div>
                <div>Net Pay: {{ number_format($earnings - $totalDeduction, 2) }}</div>
            </div>
        </div>
    </div>
